...
| 3 The ratchet | Adopted | [Two ways to bind forward](../TOOLING.md#three-ways-to-bind-forward), with the both-directions rule and the goal-dependent exception. A `--ratchet` mode is not built as merged. |
